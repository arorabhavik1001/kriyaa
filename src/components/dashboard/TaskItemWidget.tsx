        ...
        <div className="ml-4 sm:ml-5 mt-0.5">
              ...
              {task.subtasks!.map((subtask, index) => {
                ...
                return (
                  <div key={subtask.id} className="relative pl-5">
                    <div className={cn(
                      "absolute left-[7px] top-0 w-0.5 bg-border/70 rounded-full",
                      isLastChild ? "h-[17px]" : "h-full"
                    )} />
                    <div className="absolute left-[7px] top-[16px] w-[14px] h-0.5 bg-border/70 rounded-full" />
                    <div className="absolute left-[4px] top-[13px] h-2 w-2 rounded-full border-2 border-primary/60 bg-background z-[1]" />
                    <TaskItem 
                      task={subtask} 
                      level={level + 1}
          ...
          {isAddingSubtask && (
            <div className="relative pl-5">
              <div className="absolute left-[7px] top-0 h-[19px] w-0.5 bg-border/70 rounded-full" />
              <div className="absolute left-[7px] top-[18px] w-[14px] h-0.5 bg-border/70 rounded-full" />
